...
reversing_loop:
        ...
        lea rdi, [thing4]
        mov rax, [cons_min_cycles]
        mul qword [total_time]
        div qword [total_cycles]      ;hope no divide error
        mov rsi, rax
        mov rax, [rev_min_cycles]
        mul qword [total_time]
        div qword [total_cycles]
        mov rcx, rax
        mov rax, [rev_max_cycles]
        mul qword [total_time]
        div qword [total_cycles]
        mov r8, rax
        mov rax, [cons_max_cycles]
        mul qword [total_time]
        div qword [total_cycles]
        mov rdx, rax
        mov rax, 0
...
reverse_loop:        
        ...
        ;; not in some places
        ;; cdr rcx, rcx
        ;; must not use r10 now; or could mess with cdr
        mov r14, rcx
        cdr rcx, r14
...
reverse_ret:
        ...
        sub rbp, rax
        ;; rbp is now the dick
        ;; cmp rbp, [rev_min_cycles]
        ;; cmovb [rev_min_cycles], rbp
        ;; cmp rbp, [rev_max_cycles]
        ;; cmova [rev_max_cycles], rbp
