...
alloc_overflow_common:  
        ;; rax is now scratch ;WELL IT'S ASSUMED TO BE
...
alloc_overflow_noflip:
        ...
        ;; That causes problems relating to the registers that gc_flip needs to save.
        ;; FUCK THAT
        ;; Instead, shall we go for some more code duplication?
        ;; Sure, why not, it's probably not very much.
...
%%nope:
        ...
        ;; Currently we use neither of those.
