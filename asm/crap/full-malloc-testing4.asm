...
gc_flip_done_moving:
	...
	;; --You fuckup, *that* test actually sets the carry flag.
...
mov_rax_cons:
        ...
        fwd_ptr_test r14	;SETS CARRY FLAG ATM
        jnz maybe_lucky
not_lucky:
...
%%win:                          ;there must be a newline btwn this and the endmacro
        ...
        ;; Using [fromspace_mask_table].
        ;; Eliminated like a contestant in an elimination tournament.
...
%%win:
        ...
        ;; car_5: using [fromspace_mask_table]
