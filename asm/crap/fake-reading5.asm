...
midword_dick:   
        ...
        call rev_chars_to_sym
        ;; that takes arg in rbp and returns in rcx
...
last_word:
        ...
        call rev_chars_to_sym   ;value in rcx
...
print_sym:
        ;; now syms are actually dicks
        ;; lea rdi, [buec]
        ;; mov rsi, rbp
        ;; mov rax, 0
        ;; call [printf]
        ;; mov rbp, [rbp - SYM_TAG + 8] ;name ;let's use my advanced technology
        sym_name rbp, rbp
