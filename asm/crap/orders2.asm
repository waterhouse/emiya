        ...
        ;; This time, we shall handle printing ourselves.
        ...
        ;; vector: [mem-bottom] [mem-top] [stack-toppish] [output-vec] [output-vec-top]
...
return_nrevd_r11:
        ...
        ;; actually we'll print dicks



        ;; Hmm... so... there are a couple of ways to print things.
        ;; One is what I did from the Arc side just now: fancy datum
        ;; labels.
        ;; The other is to print out "((mem-addr val) ...)".
        ;; Truly, the latter is better...
        ;; ...
        ;; Yeah.
        ;; 
