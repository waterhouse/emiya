...
rejected:
        ...
        ;; Current usage and output looks like:
;; arc> (do (= h (ffi-lib "Dropbox/c-lib/dlhandle-dlsym.dylib") derp (get-ffi-obj "install_handle_and_dlsym" h (cprocedure (list $.c-_bytes) $.c-_int64))) (= u make-bytes.16) (derp u) (ga reversing-debugging3 6) (each h (join (range 0 1)) (gc) (sleep .5) (withs f (fn (x y z m u v) (pr (pad h 2) " ") (call-asm reversing-debugging3 x y z m u v)) n (* 400 (expt 2 20)) b make-bytes.n (time:do (pr (f b n 4096 u 1000 200000) " ")))))
;;  0 flips: 23 moved: 23046 mbytes: 16032 tbytes: 16032 trace-ops: 234 alloc: 4945303920
;; achtung 23
;; 24 time: 545 cpu: 546 gc: 0 mem: 5792
;;  1 flips: 23 moved: 23046 mbytes: 16032 tbytes: 16032 trace-ops: 234 alloc: 4945303920
;; achtung 23
;; 24 time: 548 cpu: 548 gc: 0 mem: 2896
