;1. Turn to vector stuff.
;2. They said O(1) hashing. Turns out they weren't kidding.
;   SBCL only looks at conses to depth 5, it seems.
;  * (eq (sxhash '(1 1 1 1 1)) (sxhash '(1 1 1 1 1 1)))
;  
;  T
