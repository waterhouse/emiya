;Ok, in new version I'll probably add type declarations (god help me)
;for whether something is a thunk.
...
($:define (_reduce-thunk f thunk gs)
  (let ((u (thunk)))
    (if (eq? u gs)
        (f)
        (let loop ((u u))
